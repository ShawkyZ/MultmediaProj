...
namespace Multimedia_Project
{
    ...
    public class ArithmeticCoder
    {
        ...
        #region private members used by the ArithmeticCoder/deArithmeticCoder methods

        /*
         * These four variables define the current state of the arithmetic
         * ArithmeticCoder/deArithmeticCoder.  They are assumed to be 16 bits long.  Note that
        ...
        private ushort input_bits_left;          /* variables keep track of the */
                                                 /* input state.                */
                                                 /* Note that there is          */
                                                 /* a possibility the deArithmeticCoder   */
        ...
        /*
         * This list represents the entire aplhabet used by the ArithmeticCoder 
         ...
         * range.  Finally, the arithmetic ArithmeticCoder module is called to
        ...
        public System.IO.MemoryStream compress(string input)
        {
            ...
            initialize_arithmetic_enArithmeticCoder();
            ...
            flush_arithmetic_enArithmeticCoder();
         ...
         * the scale is fixed here, since this is not an AdaptiveHuffman model).
         * It then asks the arithmetic deArithmeticCoder to give a high and low
         ...
         */
        public string decompress(System.IO.MemoryStream compressed_data, int size)
        {
            char c;
            ushort count;
            string retval = "";
            ...
            initialize_arithmetic_deArithmeticCoder(ref compressed_data);
            for (int i = 0; ;)
            {
        ...
        #region ArithmeticCoder/deArithmeticCoder methods
         ...
         */
        private void initialize_arithmetic_enArithmeticCoder()
        {
            low = 0;
            high = 0xffff;
            underflow_bits = 0;
         ...
         */
        private void flush_arithmetic_enArithmeticCoder()
        {
         ...
         * deArithmeticCoder.  This involves initializing the high and low registers
         * to their conventional starting values, plus reading the first
         * 16 bits from the input stream into the code value.
         */
        private void initialize_arithmetic_deArithmeticCoder(ref System.IO.MemoryStream stream)
        {
            int i;
